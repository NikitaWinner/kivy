...
Window.clearcolor = (.27, 0.34, 0.5, 0.3)
btn_color = (0.58, 0.20, 0.3, 1)
...
class InstrScr(Screen):
   def __init__(self, **kwargs):
       ...
       self.btn = Button(text='Начать', size_hint=(0.2, 0.15), pos_hint={'center_x': 0.5})
...
class PulseScr(Screen):
   def __init__(self, **kwargs):
       ...
       self.btn = Button(text='Начать', size_hint=(0.5, 0.5), pos_hint={'center_x': 0.5})
       self.btn.background_color = btn_color
       self.btn.on_press = self.next
